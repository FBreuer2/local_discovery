...
func (x *LocalAnnounce) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LocalAnnounce) ProtoMessage() {}

func (x *LocalAnnounce) ProtoReflect() protoreflect.Message {
	mi := &file_packets_proto_msgTypes[0]
...
// Deprecated: Use LocalAnnounce.ProtoReflect.Descriptor instead.
func (*LocalAnnounce) Descriptor() ([]byte, []int) {
	return file_packets_proto_rawDescGZIP(), []int{0}
}

func (x *LocalAnnounce) GetMagic() uint64 {
	if x != nil {
		return x.Magic
	}
	return 0
...
func (x *LocalAnnounce) GetPort() uint32 {
	if x != nil {
		return x.Port
	}
	return 0
...
func (x *LocalAnnounce) GetAddresses() []string {
	if x != nil {
		return x.Addresses
	}
	return nil
...
func (x *LocalAnnounce) GetExtra() []string {
	if x != nil {
		return x.Extra
	}
	return nil
...
var file_packets_proto_rawDesc = []byte{
	...
	,
...
var file_packets_proto_goTypes = []interface{}{
	(*LocalAnnounce)(nil), // 0: LocalDiscovery.LocalAnnounce
}
